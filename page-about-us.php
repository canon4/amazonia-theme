    ...
    <section class="max-w-[1440px] mx-auto w-full px-4 md:px-10 lg:px-20 py-6">
        <div class="mb-16 rounded-2xl overflow-hidden bg-slate-900 relative min-h-[500px] flex items-end shadow-2xl group">
            <div class="absolute inset-0 z-0">
                <img data-asset="images.iconos.rainforest" alt="The lush Amazon rainforest at golden hour" class="w-full h-full object-cover opacity-75 group-hover:opacity-90 transition-opacity duration-700 ease-in-out group-hover:scale-105 transform" src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/amazon_rainforest_hero.png' ); ?>" fetchpriority="high" width="1920" height="1080" />
    ...
    <section class="max-w-7xl mx-auto px-6 lg:px-20 py-16 mb-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="relative rounded-2xl overflow-hidden shadow-2xl h-full min-h-[400px] lg:min-h-[600px] group">
                <img data-asset="images.iconos.crafts" src="<?php echo esc_url( get_template_directory_uri() . '/assets/img/indigenous_crafts_community.png' ); ?>" class="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700 ease-in-out" alt="Artesana indígena tejiendo canasta" loading="lazy" width="800" height="600">
